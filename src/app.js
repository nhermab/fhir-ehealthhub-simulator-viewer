...
const pages = {
  documents: [
    "Documents",
    "Search document metadata, inspect a result, and retrieve its FHIR document or PDF.",
  ],
  observations: [
